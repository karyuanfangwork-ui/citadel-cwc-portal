...
export const STATUS_CONFIG: Record<RequestStatus, { label: string, color: string, bg: string, icon: string }> = {
  ...
  [RequestStatus.PENDING_CEO_APPROVAL_FIN]: { label: 'Pending CEO Approval (Finance)', color: 'text-amber-700', bg: 'bg-amber-100', icon: 'pending' },
  [RequestStatus.CEO_APPROVED_FIN]: { label: 'CEO Approved (Finance)', color: 'text-green-700', bg: 'bg-green-100', icon: 'check_circle' },
  [RequestStatus.CEO_REJECTED_FIN]: { label: 'CEO Rejected (Finance)', color: 'text-red-700', bg: 'bg-red-100', icon: 'cancel' },
  [RequestStatus.PENDING_CFO_APPROVAL_FIN]: { label: 'Pending CFO Approval (Finance)', color: 'text-amber-700', bg: 'bg-amber-100', icon: 'pending' },
  [RequestStatus.CFO_APPROVED_FIN]: { label: 'CFO Approved (Finance)', color: 'text-green-700', bg: 'bg-green-100', icon: 'check_circle' },
  [RequestStatus.CFO_REJECTED_FIN]: { label: 'CFO Rejected (Finance)', color: 'text-red-700', bg: 'bg-red-100', icon: 'cancel' },
  [RequestStatus.PENDING_GROUP_DCEO_APPROVAL]: { label: 'Pending Group DCEO Approval', color: 'text-purple-700', bg: 'bg-purple-100', icon: 'pending' },
  ...
  [RequestStatus.AWAITING_PAYMENT_CONFIRMATION]: { label: 'Awaiting Payment Confirmation', color: 'text-amber-700', bg: 'bg-amber-100', icon: 'hourglass_empty' },
