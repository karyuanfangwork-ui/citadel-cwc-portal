...
const ACTION_ICONS: Record<string, { icon: string; bgClass: string; textClass: string }> = {
  ...
  ROUTE_TO_GROUP_CEO_HR:{ icon: 'route',           bgClass: 'bg-orange-100', textClass: 'text-orange-600' },
  GROUP_CEO_DECISION_HR:{ icon: 'gavel',           bgClass: 'bg-red-100', textClass: 'text-red-600' },
...
function actionToModalKey(action: WorkflowActionType): string | null {
  ...
  const directMap: Record<string, string> = {
    ...
    ROUTE_TO_GROUP_CEO_HR: 'ROUTE_TO_GROUP_CEO_HR',
    GROUP_CEO_DECISION_HR: 'GROUP_CEO_DECISION_HR',
