...
interface OnboardingTasksTabProps {
    ...
    onTemplateFormChange: (form: TemplateForm) => void;
}

export const OnboardingTasksTab: React.FC<OnboardingTasksTabProps> = ({
    templates,
    templatesLoading,
    templateError,
    showTemplateForm,
        ...
        <div className="space-y-6">
            ...
            <div className="bg-white rounded-3xl border border-gray-100 overflow-hidden shadow-sm p-8">
                <div className="flex items-start justify-between mb-4">
                    <div>
                        <h2 className="text-xl font-bold text-[#101418]">Dedicated IT Agent for Onboarding</h2>
                        <p className="text-sm text-[#44546f] mt-1">
                            When an onboarding ticket is created with IT tasks, only this agent will be notified.
                            Configure who receives the IT onboarding task notifications.
                        </p>
                    </div>
                    <span className="material-symbols-outlined text-2xl text-cyan-600 flex-shrink-0">support_agent</span>
                </div>
                    ...
                    <>
                        ...
                        {currentItAgent && (
                            <div className="mb-4 p-4 bg-cyan-50 border border-cyan-200 rounded-xl flex items-center gap-3">
                                <span className="material-symbols-outlined text-xl text-cyan-600">check_circle</span>
                                <div>
                                    <p className="text-sm font-bold text-cyan-900">
                                        Currently assigned: {currentItAgent.firstName} {currentItAgent.lastName}
                                    </p>
                                    <p className="text-xs text-cyan-700">{currentItAgent.email}</p>
                                </div>
                            </div>
                        )}
                        ...
                        <div className="flex items-end gap-3">
                            <div className="flex-1">
                                ...
                                <select
                                    ...
                                    className="w-full border border-gray-300 rounded-lg px-3 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-[#0052cc] disabled:opacity-50"
                                >
                            ...
                            <button
                                ...
                                className="px-5 py-2.5 bg-[#0052cc] text-white rounded-lg text-sm font-semibold hover:bg-[#0747a6] disabled:opacity-50 disabled:cursor-not-allowed transition-colors flex items-center gap-2"
                            >
