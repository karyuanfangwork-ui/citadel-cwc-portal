...
export const RequestTypeEditModal: React.FC<RequestTypeEditModalProps> = ({
    ...
    return (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4" role="dialog" aria-modal="true" aria-label="Edit Request Type">
