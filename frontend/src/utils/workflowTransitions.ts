const VALID_TRANSITIONS: Record<string, string[]> = {
  ...
  CFO_APPROVED_FIN: ['PENDING_GROUP_DCEO_APPROVAL', 'PAYMENT_PROCESSING_FIN', 'FINANCE_IN_PROGRESS', 'COMPLETED'],
  CFO_REJECTED_FIN: ['REJECTED'],
  PENDING_GROUP_DCEO_APPROVAL: ['GROUP_DCEO_APPROVED', 'GROUP_DCEO_REJECTED'],
  GROUP_DCEO_APPROVED: ['PAYMENT_PROCESSING_FIN', 'FINANCE_ACKNOWLEDGED', 'JOB_POSTED'],
