const VALID_TRANSITIONS: Record<string, string[]> = {
  SUBMITTED: ['IN_REVIEW', 'IN_PROGRESS', 'REJECTED', 'ACKNOWLEDGED_IT', 'FINANCE_PENDING_ACK', 'PENDING_FROM_ENTITY_APPROVAL', 'PENDING_MANAGER_APPROVAL_FIN', 'PENDING_MANAGER_APPROVAL_IT'],
  ...
  GROUP_CEO_APPROVED: ['PAYMENT_PROCESSING_FIN'],
  GROUP_CEO_REJECTED: ['REJECTED'],
