const VALID_TRANSITIONS: Record<string, string[]> = {
  ...
  CFO_APPROVED_FIN: ['PENDING_GROUP_CEO_APPROVAL', 'PAYMENT_PROCESSING_FIN'],
  CFO_REJECTED_FIN: ['REJECTED'],
  PENDING_GROUP_CEO_APPROVAL: ['GROUP_CEO_APPROVED', 'GROUP_CEO_REJECTED'],
  GROUP_CEO_APPROVED: ['PAYMENT_PROCESSING_FIN', 'JOB_POSTED'],
  GROUP_CEO_REJECTED: ['REJECTED', 'SUBMITTED'],
