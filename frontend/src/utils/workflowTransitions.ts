const VALID_TRANSITIONS: Record<string, string[]> = {
  SUBMITTED: ['IN_REVIEW', 'IN_PROGRESS', 'REJECTED', 'ACKNOWLEDGED_IT', 'FINANCE_PENDING_ACK', 'PENDING_FROM_ENTITY_APPROVAL', 'PENDING_MANAGER_APPROVAL_FIN', 'PENDING_CEO_APPROVAL', 'PENDING_GROUP_DCEO_APPROVAL'],
  FINANCE_PENDING_ACK: ['FINANCE_ACKNOWLEDGED'],
  FINANCE_ACKNOWLEDGED: ['PENDING_CFO_APPROVAL_FIN'],
  FINANCE_IN_PROGRESS: ['PENDING_CFO_APPROVAL_FIN', 'TICKET_CLOSED_FIN'],
  ...
  TICKET_CLOSED_FIN: [],
  IN_REVIEW: ['IN_PROGRESS', 'ACTION_REQUIRED', 'WAITING', 'REJECTED', 'RESOLVED', 'PENDING_CEO_APPROVAL', 'PENDING_GROUP_DCEO_APPROVAL'],
