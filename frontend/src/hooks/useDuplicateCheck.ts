...
type DupState = 'idle' | 'checking' | 'clear' | 'duplicate';

/**
 * Shared duplicate-check logic for borrower creation flows.
 * Used by CreateBorrowerPage, NewBorrowerWizard, and CreditApplicationCreate.
 */
export function useDuplicateCheck() {
  ...
  return { dupCheck, dupBorrowerId, runCheck, reset };
}