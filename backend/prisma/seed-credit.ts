...
const TRANSITIONS: TransitionDef[] = [
  ...
  { fromStatus: 'OFFER',             toStatus: 'ACCEPTED',            transitionLabel: 'ACCEPT',   requiresComment: false },
  { fromStatus: 'OFFER',             toStatus: 'REJECTED',            transitionLabel: 'DECLINE',   requiresComment: true },
  ...
  { fromStatus: 'ACTIVE',            toStatus: 'WITHDRAWN',            transitionLabel: 'WITHDRAW', requiresComment: true },
  { fromStatus: 'KYC_REVIEW',        toStatus: 'DRAFT',                transitionLabel: 'RETURN',   requiresComment: true },
  { fromStatus: 'UNDERWRITING',       toStatus: 'KYC_APPROVED',       transitionLabel: 'RETURN',   requiresComment: true },
  { fromStatus: 'CREDIT_ASSESSMENT', toStatus: 'UNDERWRITING',         transitionLabel: 'RETURN',   requiresComment: true },
  { fromStatus: 'COMMITTEE_REVIEW',  toStatus: 'CREDIT_ASSESSMENT',   transitionLabel: 'RETURN',    requiresComment: true },
  { fromStatus: 'KYC_REJECTED',      toStatus: 'DRAFT',                transitionLabel: 'RESUBMIT',  requiresComment: true },
  { fromStatus: 'REJECTED',           toStatus: 'DRAFT',                transitionLabel: 'RESUBMIT',  requiresComment: true },
