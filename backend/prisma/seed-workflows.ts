...
const defaultWorkflows = [
  ...
  },
  {
    ...
    steps: [
      ...
      { label: 'Group CEO Approval', status: 'PENDING_GROUP_CEO_APPROVAL', icon: 'radio_button_checked', slaPause: true },
      { label: 'Group CEO Approved', status: 'GROUP_CEO_APPROVED', icon: 'check_circle' },
