...
async function main() {
    ...
    const permissions = [
        ...
        { name: 'crm:import', resource: 'crm', action: 'import', description: 'Import CRM data from CSV or Excel files' },
        { name: 'crm:export', resource: 'crm', action: 'export', description: 'Export CRM data to CSV or Excel files' },
    ...
    const adminPerms = [
        ...
        'crm:read', 'crm:write', 'crm:delete', 'crm:admin', 'crm:import', 'crm:export', 'crm:read:team',
    ...
    const rolePermissionMap: Record<string, string[]> = {
        ...
        SALES_REP: ['crm:read', 'crm:write', 'crm:import', 'crm:export'],
