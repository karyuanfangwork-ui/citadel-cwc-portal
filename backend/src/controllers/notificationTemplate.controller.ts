...
const EVENT_TYPE_REGISTRY: {
    ...
    { eventType: 'APPROVAL_REQUIRED',         label: 'Executive Approval Required', category: 'IT Workflow', recipientDescription: 'Executive approver', availableVariables: ['requestId', 'requestUuid', 'requestTitle', 'approverRole', 'role', 'approvalLevel', 'requestTypeName', 'currency', 'amount', 'approvalPolicyReason', 'userName', 'appUrl'] },
    { eventType: 'APPROVAL_REMINDER_FIRST',   label: 'First Approval Reminder',     category: 'IT Workflow', recipientDescription: 'Pending approver', availableVariables: ['requestId', 'requestUuid', 'requestTitle', 'hours', 'userName', 'appUrl'] },
    { eventType: 'APPROVAL_REMINDER_SECOND',  label: 'Second Approval Reminder',    category: 'IT Workflow', recipientDescription: 'Pending approver', availableVariables: ['requestId', 'requestUuid', 'requestTitle', 'hours', 'userName', 'appUrl'] },
    ...
    { eventType: 'FINANCE_GROUP_DCEO_DECISION', label: 'Group Deputy CEO Decision',         category: 'Finance', recipientDescription: 'Requester', availableVariables: ['requestId', 'requestUuid', 'requestTitle', 'decision', 'approvalStage', 'approvalPolicyReason', 'currency', 'amount', 'userName', 'appUrl'] },
