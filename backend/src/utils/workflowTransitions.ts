...
const VALID_TRANSITIONS: Record<string, string[]> = {
  ...
  CEO_APPROVED: ['PENDING_GROUP_DCEO_APPROVAL', 'ACTION_REQUIRED'],  // ESM Travel: skips DCEO if below threshold
  ...
  GROUP_DCEO_APPROVED: ['JOB_POSTED', 'ACTION_REQUIRED'],  // JOB_POSTED=HR, ACTION_REQUIRED=ESM Travel
  ...
  FINANCE_IN_PROGRESS: ['PENDING_CFO_APPROVAL_FIN', 'CANCELLED'],
