...
const VALID_TRANSITIONS: Record<string, string[]> = {
  ...
  CEO_APPROVED: ['PENDING_GROUP_DCEO_APPROVAL'],  // ESM Travel: always routes to DCEO
  ...
  GROUP_DCEO_APPROVED: ['JOB_POSTED', 'FINANCE_ACKNOWLEDGED'],  // JOB_POSTED=HR, FINANCE_ACKNOWLEDGED=ESM Travel
